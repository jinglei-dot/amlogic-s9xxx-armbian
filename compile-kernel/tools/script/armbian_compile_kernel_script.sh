...
get_kernel_source() {
    ...
    echo -e "${STEPS} Start downloading the kernel branch ${code_branch} source code..."
...
compile_kernel() {
    ...
    echo -e "${STEPS} Install modules [ ${out_kernel} ]..."
...
echo -e "${INFO} Kernel input_r_value: [ ${input_r_value} ]"
echo -e "${INFO} Kernel code_owner: [ ${code_owner} ]"
echo -e "${INFO} Kernel code_repo: [ ${code_repo} ]"
echo -e "${INFO} Kernel code_branch: [ ${code_branch} ]"
echo -e "${INFO} Kernel current_path: [ ${current_path} ]"
echo -e "${INFO} Kernel compile_path: [ ${compile_path} ] \n"
echo -e "${INFO} Kernel out_kernel: [ ${out_kernel} ] \n"
